...
# MAGIC To run this demo, just select the cluster `dbdemos-computer-vision-pcb-jose_alfonso` from the dropdown menu ([open cluster configuration](https://adb-984752964297111.11.azuredatabricks.net/#setting/clusters/0823-113149-y4f2njrc/configuration)). <br />
...
# MAGIC <img width="1px" src="https://www.google-analytics.com/collect?v=1&gtm=GTM-NKQ8TT7&tid=UA-163989034-1&aip=1&t=event&ec=dbdemos&ea=VIEW&dp=%2F_dbdemos%2Fdata-science%2Fcomputer-vision-pcb%2F05-torch-lightning-training-and-inference&cid=984752964297111&uid=611030176140983">
...
# MAGIC %sql
# MAGIC USE CATALOG techsummit_cvops_development;
# MAGIC USE SCHEMA pcb;
# MAGIC SHOW TABLES

# COMMAND ----------

train = spark.table("test_deltatorch")
train.display()
